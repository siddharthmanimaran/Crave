...
app.post('/api/add/fake', generateData);
app.post('/api/delete/fake', deleteLast100k);
...
async function deleteLast100k() {
    try {
        const batchSize = 30000;

        // Aggregate to get the _id of last 100k documents
        const docsToDelete = await Product.aggregate([
